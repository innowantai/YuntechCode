function [maxima,minimum,mm,nn]=A_extremanumber(r,x)
iterm=0;
itern=0;
ll=length(r);
maxima=ones(2,round(ll/2)).*1000;
minimum=ones(2,round(ll/2)).*1000;
i=2;
mm=0;
nn=0;
i2=0;
