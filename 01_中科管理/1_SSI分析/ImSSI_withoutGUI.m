function [dt,Fin0,FYLimi,iint,imax,infn,inPHI_I,inPHI_R,inxi,wnrang ] = ImSSI_withoutGUI(yy,dt,n3,iint,imax,work,filename,wnrang)

[l ny]=size(yy);if (ny<l);yy=yy';[l ny]=size(yy); end
svdFoldername = ['SVDresultData']; 
work_ori = cd;
